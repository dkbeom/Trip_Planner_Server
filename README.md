...
<img src="image/STP.png" height="200"/>
...
1. 코로나 방역 완화로 오랜만에 여행을 떠나고자 하는 사람들
2. 해외여행 여건이 되지 않아 국내여행을 하려하지만 어떤 여행지를 가야할지 모르는 사람들
3. 여행을 가고 싶지만 계획을 짤 시간이 없는 바쁜 현대인들
  
-----------
## 2. 주요 기능

### 2.1. 여행 스케쥴을 만들어 주는 기능
