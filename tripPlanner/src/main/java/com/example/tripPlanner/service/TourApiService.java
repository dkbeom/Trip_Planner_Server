...
public interface TourApiService {
	...
	List<Place> getLocationPlaceList(String mapX, String mapY, Integer radius, String cat1);
	List<Place> getLocationPlaceList(String mapX, String mapY, Integer radius, String cat1, String cat2);
	List<Place> getLocationPlaceList(String mapX, String mapY, Integer radius, String cat1, String cat2, String cat3);
